% This function does not assume that all subspaces have the same dimension,
% and instead uses a parameter 'pct' to control the amount of variability
% to capture within each cluster.

% Last updated: 5th Jun. 2019


function [perf labs nmi] = KSCALq(X, K, pct, mem, T, b, Truth, strategy, influence, LabUpdate, NumCores)
